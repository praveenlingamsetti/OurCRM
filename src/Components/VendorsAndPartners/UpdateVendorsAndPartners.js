...
// Define an initial state for the contact information form
const initialState = {
  firstName: "",
  lastName: "",
  email: "",
...
const UpdateContact = () => {
  ...
  const [contactDetails] = useState(location.state);
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    try {
      // Make an API request to update the contact information
      api
        .put(
          `/app/vendorpartners/updateVendorPartner/${contactDetails?.vendorPartnerId}`,
          contactInfo
        )
        .then((res) => {
  ...
  // Fetch contact details from the API when the component mounts
  useEffect(() => {
    api
      .get(`/app/vendorpartners/${contactDetails?.vendorPartnerId}`)
      .then((res) => {
        // console.log(res.data);
            ...
            <div className="col-md-12">
              ...
              >
                <div className="card-header">
                  <h2 className="text-info">Update Vendor/Partner</h2>
                </div>
